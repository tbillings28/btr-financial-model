...
const BTRFinancialModelPrototype = () => {
  ...
  const calculateIRR = (cashFlows) => {
    // Implement a more accurate IRR calculation
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-gray-50">
      <h1 className="text-3xl font-bold mb-6 text-center">BTR Financial Model Prototype</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4">Fund Structure</h2>
          
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">Total Homes</label>
            <input
              type="number"
              name="phase1Homes"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">3-Bed Homes</label>
            <input
              type="number"
              name="phase1Bed3"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">4-Bed Homes</label>
            <input
              type="number"
              name="phase1Bed4"
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">Loan to Value (LTV)</label>
            <select
              name="loanToValue"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">Hold Period (Years)</label>
            <select
          ...
          {inputs.exitStrategy === "portfolio" && (
            <div className="mb-4">
              ...
              <p className="text-xs text-gray-500 mt-1">Lower cap rate = higher sale value</p>
            </div>
          )}
          
          {inputs.exitStrategy === "individual" && (
            <div className="mb-4">
              <label className="block text-sm font-medium mb-1">Individual Sale Premium</label>
              <select
              ...
              <p className="text-xs text-gray-500 mt-1">Premium over portfolio market value</p>
            </div>
          )}
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">3-Bed Acquisition Price</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">3-Bed Market Value</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">3-Bed Monthly Rent</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">4-Bed Acquisition Price</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">4-Bed Market Value</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">4-Bed Monthly Rent</label>
            <input
              type="number"
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-8">
        <h2 className="text-2xl font-semibold mb-6">Investment Returns Dashboard</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold mb-2">Equity Multiple</h3>
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold mb-2">Cash Yield</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-8">
        <h2 className="text-xl font-semibold mb-4">Portfolio Value & Equity Over Time</h2>
        <div className="h-64">
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-8">
        <h2 className="text-xl font-semibold mb-4">Annual Cash Flow Projection</h2>
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={cashFlowChartData} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="year" />
              <YAxis />
              <Tooltip formatter={(value) => formatCurrency(value)} />
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-xl font-semibold mb-4">Annual Cash Flow Details</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full border-collapse">
            <thead>
              <tr className="bg-gray-100">
                <th className="p-2 border">Year</th>
                <th className="p-2 border">NOI</th>
                <th className="p-2 border">Debt Service</th>
                <th className="p-2 border">DSCR</th>
                <th className="p-2 border">Investor Distributions</th>
                <th className="p-2 border">Cash Yield</th>
              </tr>
            </thead>
            <tbody>
              {results.cashFlows.map((year) => (
                <tr key={year.year}>
                  <td className="p-2 border">Year {year.year}</td>
                  <td className="p-2 border">{formatCurrency(year.noi)}</td>
                  <td className="p-2 border">{formatCurrency(year.debtService)}</td>
                  <td className="p-2 border">{year.dscr.toFixed(2)}</td>
                  <td className="p-2 border">{formatCurrency(year.lpDistribution)}</td>
                  <td className="p-2 border">{year.cashYield.toFixed(2)}%</td>
                </tr>
              ))}
            </tbody>
          </table>
